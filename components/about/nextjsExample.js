...
const nextjsExample = {
  ...
  export default function CoverArt({imgUrlLarge, showLargeImg, handleCloseClick}) {  const [isImgLoading, setIsImgLoading] = useState(true)
